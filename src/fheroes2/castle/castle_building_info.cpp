...
namespace
{
    std::vector<fheroes2::Rect> getKnightBuildingArea( const BuildingType buildingId )
    {
        switch ( buildingId ) {
    ...
    std::vector<fheroes2::Rect> getBarbarianBuildingArea( const BuildingType buildingId )
    {
        switch ( buildingId ) {
        case BUILD_THIEVESGUILD:
            return { { 466, 94, 87, 47 } };
    ...
    std::vector<fheroes2::Rect> getSorceressBuildingArea( const BuildingType buildingId )
    {
        switch ( buildingId ) {
        case BUILD_THIEVESGUILD:
    ...
    std::vector<fheroes2::Rect> getWarlockBuildingArea( const BuildingType buildingId )
    {
        switch ( buildingId ) {
        case BUILD_THIEVESGUILD:
        ...
        case BUILD_CAPTAIN:
            return { { 418, 83, 53, 84 } };
        case BUILD_MAGEGUILD1:
            return { { 590, 135, 50, 35 } };
        case BUILD_MAGEGUILD2:
            return { { 590, 108, 50, 60 } };
        case BUILD_MAGEGUILD3:
            return { { 590, 77, 50, 90 } };
        case BUILD_MAGEGUILD4:
            return { { 590, 45, 50, 125 } };
        case BUILD_MAGEGUILD5:
            return { { 590, 14, 50, 155 } };
        case BUILD_TENT:
